...
export interface IPersonalMessage extends Document {
  content: string
  greetings: string
  title: string
  type: string
...
const PersonalMessageSchema: Schema = new Schema(
  {
...
export const PersonalMessage = mongoose.model<IPersonalMessage>(
  'PersonalMessage',
