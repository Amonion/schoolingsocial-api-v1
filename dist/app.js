...
const companyRoutes_1 = __importDefault(require("./routes/company/companyRoutes"));
const staffRoutes_1 = __importDefault(require("./routes/company/staffRoutes"));
...
const commentRoutes_1 = __importDefault(require("./routes/post/commentRoutes"));
...
const statRoutes_1 = __importDefault(require("./routes/company/statRoutes"));
...
app.use('/api/v1/staffs', staffRoutes_1.default);
