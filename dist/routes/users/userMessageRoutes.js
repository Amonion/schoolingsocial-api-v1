...
router
    ...
    .post(upload.any(), messageController_1.readNotifications);
...
router.route('/notifications/:username').patch(upload.any(), messageController_1.updateNotification);
router.route('/:connection').post(upload.any(), chatController_1.createChatMobile);
